...
const MOCK_PLAYLIST_SONGS: Song[] = Array.from({ length: 12 }, (_, i) => ({
    ...
    audioUrl: [
        ...
        'https://upload.wikimedia.org/wikipedia/commons/a/a9/Wagner_-_Ride_of_the_Valkyries.mp3',
        'https://upload.wikimedia.org/wikipedia/commons/3/3e/Rimsky-Korsakov_-_Flight_of_the_Bumblebee.mp3',
    ][i],
    trackNumber: i + 1,
